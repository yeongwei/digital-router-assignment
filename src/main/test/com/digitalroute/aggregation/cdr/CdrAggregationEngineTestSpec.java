...
public class CdrAggregationEngineTestSpec {
    ...
    public void test() {
        ...
        AggregationRecord aggregationRecord1 = cdrAggregationEngine.getAndRemove(cdrRec1);
        ...
        AggregationRecord aggregationRecord2 = cdrAggregationEngine.getAndRemove(cdrRec2);
