...
public class FieldDescriptorTestSpec {
    ...
    public void testString() {
        ...
        assertTrue(fv.value() == "digitalrouter");
        assertTrue(fv.value().equals("digitalrouter"));
    }
    ...
    public void testInt() {
        ...
        assertTrue(fv.value() == Integer.valueOf(100));
        assertTrue(fv.value().equals(100));
    }
    ...
    public void testByte() {
        ...
        assertTrue(fv.value() == Byte.valueOf("127"));
        assertTrue(fv.value().equals((byte) 127));
    }
    ...
    public void testLong() {
        ...
        assertTrue(fv.value() == Long.valueOf("127"));
        assertTrue(fv.value().equals((long) 127));
    }
